...
class AuthController extends Controller
{
    ...
    public function loginAdministrador(LoginRequest $request): JsonResponse {
        ...
        $ip = $request->header('X-Forwarded-For')[0] ?? $request->ip(); // Obtenemos la IP del usuario que realiza la petición, si hay proxy obtenemos la auténtica con X-Forwarded-For
