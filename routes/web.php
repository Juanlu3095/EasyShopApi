...
Route::post('/pagotarjeta/notification', [RedsysController::class, 'notification'])->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class])->name('redsys.notification'); // Donde se tratan datos más sensibles con pagos ok
